...
def get_reception_db_connection():
    """Get connection to reception database"""
...
def init_db():
    ...
    # Consumption bills table
    conn.execute('''CREATE TABLE IF NOT EXISTS consumption_bills (
                    id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    conn.execute('''CREATE TABLE IF NOT EXISTS bill_items (
                    ...
                    quantity REAL NOT NULL,
                    location TEXT,
                    FOREIGN KEY(bill_id) REFERENCES consumption_bills(id))''')
    
    # Draft bills table
    conn.execute('''CREATE TABLE IF NOT EXISTS draft_bills (
                    id INTEGER PRIMARY KEY AUTOINCREMENT,
                    employee_name TEXT,
                    employee_signature TEXT,
                    last_updated TEXT)''')
    ...
    conn.execute('''CREATE TABLE IF NOT EXISTS draft_bill_items (
                    id INTEGER PRIMARY KEY AUTOINCREMENT,
                    ...
                    quantity REAL NOT NULL,
                    location TEXT,
                    FOREIGN KEY(draft_id) REFERENCES draft_bills(id))''')
    
    # Reception sheets table
    reception_conn.execute('''CREATE TABLE IF NOT EXISTS reception_sheets (
                            id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    reception_conn.execute('''CREATE TABLE IF NOT EXISTS reception_items (
                            id INTEGER PRIMARY KEY AUTOINCREMENT,
                            ...
                            FOREIGN KEY(reception_id) REFERENCES reception_sheets(id))''')
    
    # Draft receptions table
    reception_conn.execute('''CREATE TABLE IF NOT EXISTS draft_receptions (
                            id INTEGER PRIMARY KEY AUTOINCREMENT,
                            supplier TEXT,
                            document_number TEXT,
                            notes TEXT,
    ...
    # Draft reception items table
    reception_conn.execute('''CREATE TABLE IF NOT EXISTS draft_reception_items (
                            id INTEGER PRIMARY KEY AUTOINCREMENT,
                            draft_id INTEGER NOT NULL,
                            item_number INTEGER NOT NULL,
                            product_code TEXT NOT NULL,
                            ...
                            quantity REAL NOT NULL,
                            location TEXT,
                            FOREIGN KEY(draft_id) REFERENCES draft_receptions(id))''')
